...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    # in this exercise.
    hr_team_year = pandas.read_csv(hr_by_team_year_sf_la_csv)

    gg = (ggplot(hr_team_year, aes('HR', 'yearID', color='teamID')) + ggtitle('Number of HR per year') + geom_point() +
          geom_line() + xlab('Year') + ylab("HR"))
    return gg


if __name__ == "__main__":
    plot = lineplot_compare('hr_by_team_year_sf_la.csv')
    print plot
